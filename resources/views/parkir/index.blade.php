    ...
    <div class="container">
        <header>
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
                ...
                <a href="{{ route('admin.login') }}" class="admin-link" title="Login Admin">🔐 Admin</a>
            </div>
...
<script>
    $(document).ready(function () {
            ...
            function loadTarif() {
                $.get("{{ route('api.tarif') }}", function(response) {
                    try {
                        var data = typeof response === 'string' ? JSON.parse(response) : response;
            ...
            function fetchData() {
                $.get("{{ route('api.kendaraan') }}", function (data) {
                    try {
